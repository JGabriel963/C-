...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    private void CreateTotalEspentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        paragraph.AddFormattedText($"{CURRENCYF_SYMBOL} {totalExpenses:f2}", new Font { Name = FontHelper.WORKSANS_BLACK, Size = 50 });
    ...
    {
        cell.AddParagraph($"{CURRENCYF_SYMBOL} {amount:f2}");
