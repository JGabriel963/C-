...
{
    private const string CURRENCYF_SYMBOL = "R$";
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        CreateTotalEspentSection(page, month, totalExpenses);
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "João Gabriel";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "UseCase", "Expenses", "Reports", "Pdf", "Logo", "profile.jpg");
        ...
        row.Cells[1].AddParagraph("Hey, João Gabriel!");
        row.Cells[1].Format.Font = new Font { Name = FontHelper.RALEWAY_BLACK, Size = 16 };
        row.Cells[1].VerticalAlignment = MigraDoc.DocumentObjectModel.Tables.VerticalAlignment.Center;

    }

    private void CreateTotalEspentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        paragraph.AddFormattedText($"{CURRENCYF_SYMBOL} {totalExpenses}", new Font { Name = FontHelper.WORKSANS_BLACK, Size = 50 });
    ...
    {
        cell.AddParagraph($"{CURRENCYF_SYMBOL} {amount}");
